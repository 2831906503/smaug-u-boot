...
static const struct tegra_gpio_config google_smaug_gpio_inits[] = {
	/*        port, pin, init_val */

	// ==== Known good ====
	GPIO_INIT(K,    0,   IN), // Board ID 0
	GPIO_INIT(K,    1,   IN), // Board ID 1

	GPIO_INIT(X,    5,   IN), // Power button (act low)
	...
	// LCD something
	GPIO_INIT(V,    0,   OUT0), /* LCD_EN */
	GPIO_INIT(V,    1,   OUT0), /* LCD_RST_L */

	// SPI Write Protect
	GPIO_INIT(K,    2,   OUT1), /* QSPI /WP pin */
...
static const struct pmux_pingrp_config google_smaug_pingrps[] = {
	...
	// EN_VDD_LCD
	PINCFG(LCD_GPIO1_PV3,        DEFAULT,    NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	// EN_VDD18_LCD
	PINCFG(LCD_GPIO2_PV4,        DEFAULT,    NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(PK2,                  I2S5B,      DOWN,   NORMAL,   OUTPUT,  DISABLE, DEFAULT),
...
static const struct pmux_drvgrp_config google_smaug_drvgrps[] = {
};
